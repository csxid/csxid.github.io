...
export function ScanPositionMarkers(props) {
    ...
    var scanPositions = props.scanPositions;
    ...
    // console.log("scan position markers render");
    return(
...
export function Ground(props) {
    const ground = new THREE.Mesh(
        new THREE.PlaneGeometry( 9, 9, 1, 1 ).rotateX(-Math.PI/2),
        new THREE.MeshPhongMaterial( { color: 0xa0adaf, shininess: 150 } )
    );
    return (
        <primitive object={ground} {...props} />
    )    
}
